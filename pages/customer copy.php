                                ...
                                <div class="modal-body">
                                    <form action="savecustomer copy.php" method="post" enctype="multipart/form-data" class= "form-group">
                                        <div id="ac">
                                            ...
                                            <span>Last Name : </span><input type="text" required="required" name="lname" class = "form-control" />
                                            <span>Address : </span><input type="text" required="required" name="address" class = "form-control" />
                                            <span>Contact : </span><input type="text" required="required" name="contact" class = "form-control" />
                                            <span>Membership No. : </span><input type="text" required="required" name="memno" class = "form-control" value = "<?php echo $pcode ?>" />
                                            <span>Upload Image:</span> <input type="file" required="required" id="image" name="image" class="form-control"> 
